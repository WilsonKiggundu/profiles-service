...
namespace ProfileService.Migrations
{
    ...
    [Migration("20200929092106_AddedInvestorModels")]
    partial class AddedInvestorModels
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProfileService.Models.Common.Upload", b =>
                {
                    ...
                    b.Property<Guid?>("BusinessProductId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ProfileService.Models.Common.Contact", b =>
                {
                    b.HasOne("ProfileService.Models.Investor.Investor", null)
                        .WithMany("Contacts")
            ...
            modelBuilder.Entity("ProfileService.Models.Common.Upload", b =>
                {
                    b.HasOne("ProfileService.Models.Business.BusinessProduct", null)
                        .WithMany("Uploads")
                        .HasForeignKey("BusinessProductId");
                });
